...
PROGRAM_CATALOG = {
    ...
    'TBD-u-next': {
        'label': 'U-NEXT',
        'tags': ['U-NEXT', 'VOD', '動画配信', '見放題', '無料体験', '映画',
                 '海外ドラマ', '韓国ドラマ', 'アニメ', '雑誌', '4K'],
        'type': 'banner',
    },
    'TBD-hulu': {
        'label': 'Hulu',
        'tags': ['Hulu', 'VOD', '海外ドラマ', '日テレ', '見放題', 'FOX',
                 'HBO', '動画配信'],
        'type': 'banner',
    },
    'TBD-fod': {
        'label': 'FODプレミアム',
        'tags': ['FOD', 'フジテレビ', 'ドラマ', 'バラエティ', '雑誌',
                 '見逃し配信', '月9'],
        'type': 'banner',
    },
    'TBD-telasa': {
        'label': 'TELASA',
        'tags': ['TELASA', 'テレビ朝日', '仮面ライダー', '戦隊', '特撮',
                 'ドラマ', 'au'],
        'type': 'banner',
    },
    # ── 韓ドラ・K-POP ──
    'TBD-lemino': {
        'label': 'Lemino',
        'tags': ['Lemino', '韓国ドラマ', 'K-POP', 'ドコモ', 'ライブ配信',
                 '韓ドラ', '音楽'],
        'type': 'banner',
    },
    # ── ライト層・オリジナル ──
    ...
    'TBD-dazn': {
        'label': 'DAZN',
        'tags': ['DAZN', 'スポーツ', 'サッカー', 'Jリーグ', '野球',
                 'MLB', 'F1', 'テニス', 'ライブ配信', '中継'],
        'type': 'banner',
    },
    'TBD-wowow': {
        'label': 'WOWOWオンデマンド',
        'tags': ['WOWOW', '音楽ライブ', 'テニス', 'プロレス', '海外ドラマ',
                 'スポーツ', '4K'],
        'type': 'banner',
    },
    # ── アニメ特化 ──
    'TBD-danime': {
        'label': 'dアニメストア',
        'tags': ['dアニメ', 'アニメ', '見放題', '声優', '2.5次元',
                 '深夜アニメ', '550円', '安い'],
        'type': 'banner',
    },
    'TBD-dmm-tv': {
        'label': 'DMM TV',
        'tags': ['DMM TV', 'アニメ', '2.5次元', '舞台', '韓国ドラマ',
                 'オリジナル', 'DMMポイント'],
        'type': 'banner',
    },
}
